...
const TopBar = ({ user, searchQuery, setSearchQuery, onMenuClick }) => {
    return (
        <header className="h-14 flex-shrink-0 flex items-center justify-between px-4 md:px-6 border-b border-white/5 bg-slate-900/80 backdrop-blur-md z-20 sticky top-0">
            ...
            <div className="flex items-center gap-4">
                ...
                {/* Search - Compact */}
                <div className="relative w-full max-w-[200px] md:w-72">
            ...
            <div className="flex items-center gap-3 md:gap-4">
                ...
                <Link to="/profile" className="flex items-center gap-3 pl-3 md:pl-4 border-l border-white/10 hover:opacity-80 transition-opacity">
